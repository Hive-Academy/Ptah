        ...
        @if (!selectedTemplate()) {
          ...
          <div class="parameter-config">
            ...
            <div class="config-header">
              <button class="back-button" (click)="clearSelection()">← Back to Gallery</button>
            ...
            <div class="config-grid">
                  ...
                  @for (parameter of selectedTemplate()?.parameters || []; track parameter.name) {
                    <div class="parameter-field">
                      ...
                      @switch (parameter.type) {
                        ...
                        @case ('select') {
                          <select [formControlName]="parameter.name" class="vscode-select">
                            @if (!parameter.required) {
                        ...
                        @case ('boolean') {
                          <label class="checkbox-label">
                            <input [formControlName]="parameter.name" type="checkbox" />
                      ...
                      @if (
                        parameterForm.get(parameter.name)?.errors &&
                        parameterForm.get(parameter.name)?.touched
                      ) {
              ...
              <div class="preview-panel">
                ...
                <div class="command-preview">
                  <pre>{{
                    previewCommand() || 'Configure parameters above to see the command preview...'
                  }}</pre>
                </div>
